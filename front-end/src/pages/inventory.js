...
export default function Inventory() {
    const [form, setForm] = useState({name:"", launchDate:"", mainCharacter:"", gameDirector:"", producer:"", platform:""})
        ...
        <div className="bg-slate-100 h-full">
            ...
            <div className="bg-cyan-400 grid grid-cols-1 md:grid-cols-4 md:mx-36 md:my-8 md:rounded-3xl">
                <div id="gameForm" className="mx-auto mt-16 mb-8 col-span-1 md:col-span-2 md:col-start-2 grid grid-cols-1">
                    <label className="font-mainFont mx-auto text-xl" htmlFor="name">Name</label>
                    <input className="py-0.5 rounded-2xl mb-4 bg-stone-800 text-slate-100 font-mainFont p-auto text-center" type="text" id="name" name="name" onChange={ev => {captureInput(ev.target.id, ev.target.value)}}></input>
                    ...
                    <label className="font-mainFont mx-auto text-xl" htmlFor="platform">Platform</label>
                    <input className="py-0.5 rounded-2xl mb-4 bg-stone-800 text-slate-100 font-mainFont p-auto text-center" type="text" id="platform" name="platform" onChange={ev => {captureInput(ev.target.id, ev.target.value)}}></input>
